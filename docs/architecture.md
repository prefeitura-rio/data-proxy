...
The sync pipeline has three components. Each component writes one JSON log record per line. Search logs with `component`, `sync_id`, `table`, `stage`, or `consumer_path`.
