...
def test_planned_paths_rejects_invalid_partition_plan() -> None:
...
def test_partition_predicate_rejects_invalid_selection_branch() -> None:
    ...
    with (
        ...
        partition_predicate(
            cast("PhysicalPartition", cast(object, SimpleNamespace(selection=object())))
        )
